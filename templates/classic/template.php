<?php
// Classic Template — ATS-safe single column
// Variables available: $sections (array), $customization (array)
...
<div class="resume-wrap">
    ...
    <header class="r-header">
        ...
        <div class="r-title"><?= e($personal['job_title']) ?></div>
        <?php endif; ?>
        <div class="r-contact">
            ...
            <?php if (!empty($personal['linkedin'])): ?><span>in <?= e($personal['linkedin']) ?></span><?php endif; ?>
            <?php if (!empty($personal['website'])): ?><span>⬡ <?= e($personal['website']) ?></span><?php endif; ?>
            <?php if (!empty($personal['github'])): ?><span>⌥ <?= e($personal['github']) ?></span><?php endif; ?>
        </div>
    </header>
    ...
    <section class="r-section">
        ...
        <?php if ($sec['type'] === 'summary'): ?>
            <div class="r-summary"><p><?= nl2br(e($summary)) ?></p></div>
        ...
        <?php elseif ($sec['type'] === 'skills'): ?>
            ...
            <div class="r-skills-list">
                ...
                <span class="r-skill-tag"><?= e($sk) ?></span>
                <?php endforeach; ?>
            </div>
