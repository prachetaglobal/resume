...
// Render a section's content (shared between sidebar and main)
function renderSectionContent(array $sec, string $summary): void {
    $items = $sec['items'];
    if ($sec['type'] === 'summary'): ?>
...
<div class="resume-wrap">
    ...
    <div class="r-sidebar">
        ...
        <div class="r-section" data-section-id="<?= $sec['id'] ?>">
            ...
            <?php renderSectionContent($sec, $summary); ?>
        </div>
        <?php endforeach; ?>
    </div>
